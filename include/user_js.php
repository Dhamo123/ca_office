...
function Edit_Customer(id) {
  $.ajax({
    ...
    success: function(data) {
      ...
      $('#update_customer_modal input[name="code"]').val(data.code);
      $('#update_customer_modal input[name="telephone"]').val(data.telephone);
      $('#update_customer_modal input[name="password"]').val(data.show_password);
      $('#update_customer_modal input[name="id"]').val(data.customer_id);
      $('#update_customer_modal input[name="permission_add"]').attr("checked",(data.permission_add=='Yes')?true:false);
      $('#update_customer_modal input[name="permission_edit"]').attr("checked",(data.permission_edit=='Yes')?true:false);
      $('#update_customer_modal input[name="permission_delete"]').attr("checked",(data.permission_delete=='Yes')?true:false);
